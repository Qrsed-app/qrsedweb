...
import { validateEmail, validatePassword, type SignInFormData } from "../lib/schemas";
    ...
    <div className="min-h-screen flex items-center justify-center bg-background">
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1">
          ...
          <CardDescription className="text-center">Sign in to your Qursed account</CardDescription>
        </CardHeader>
        <CardContent>
